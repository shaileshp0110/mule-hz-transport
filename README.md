...
There is also transformer which is used to convert any payload to the IMessage type, so you thepayload get coneverted to HzMessage 
And also transformer to get the message from the map based on the name of the map
