 ...
 * User: shailesh
 * Date: 11/03/2013
 * <code>HzMuleMessageFactory</code> TODO document
 */
public class HzMuleMessageFactory extends AbstractMuleMessageFactory
{
    ...
    public HzMuleMessageFactory(MuleContext context)
    {
        super(context);
    }
    ...
    protected Class<?>[] getSupportedTransportMessageTypes()
    {
        ...
        return new Class[]{IMessage.class , MuleMessage.class};
